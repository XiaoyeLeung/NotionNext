...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，synthetic biology','BUCT',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BUCT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '聚焦国际贫穷地区的青少年和大学生，传播合成生物学', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.biosyn-bridge.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'synthetic biology', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/docs/platformlogo.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Hi, synthetic biology', // 站点描述，被notion中的页面描述覆盖
