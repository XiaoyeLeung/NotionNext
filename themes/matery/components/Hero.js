  ...
  return (
    <header
      ...
      <div className='text-white absolute flex flex-col h-full items-center justify-center w-full '>
        ...
        {/* 站点欢迎语 */}
        <div className='mt-2 h-12 items-center text-center shadow-text text-white text-2xl'>
          <span id='typed' />
        </div>
        {/* 滚动按钮 */}
        <div
          ...
          className='glassmorphism mt-12 border cursor-pointer w-40 text-center pt-4 pb-3 text-md text-white hover:bg-green-900 duration-300 rounded-3xl z-40'>
